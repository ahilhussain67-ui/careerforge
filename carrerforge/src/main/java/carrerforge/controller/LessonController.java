...
public class LessonController {
 ...
 @GetMapping("/courses/{courseId}/lessons") public List<LessonResponse> lessons(@PathVariable Long courseId){return service.forCourse(courseId).stream().map(LessonResponse::from).toList();}
